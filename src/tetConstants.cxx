...
const int tetConstants::wait_to_play_first_piece_ms = 3000;
const int tetConstants::switch_key_pause_ms = 10;
const int tetConstants::pause_between_drops_ms = 65;
const int tetConstants::pause_between_keypresses_ms = 60;
const int tetConstants::pause_after_clear_ms = 350;
